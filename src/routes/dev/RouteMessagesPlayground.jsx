...
const SUCCESS = [
  ...
  ["Flagged for masking", () => notify.success(messages.status.flaggedForMasking)],
...
const ERRORS = [
  ...
  ["Multiple SEG images", () => notify.error(messages.errors.multipleSegImages(123456))],
];
...
const THROWABLES = [
  ...
  [
    ...
    () => notify.error(new Error("internal: socket hang up"), messages.errors.network),
  ],
    ...
    <div className="pg">
      <header className="pg-header">
        ...
        <p className="pg-hint">
          ...
          app-wide check, use DevTools → Rendering → “Emulate prefers-color-scheme”.
        </p>
      </header>
      ...
      <Section title="Info & loading">
        <div className="pg-grid">
          <FireButton label="Info" onClick={() => notify.info("Heads up — this is an info toast.")} />
          <FireButton
      ...
      <Section title="In-view components">
        <div className="pg-previews">
          ...
          <div className="pg-preview">
            <div className="pg-preview__caption">ErrorState (with detail + retry)</div>
            <div className="pg-preview__stage">
              <ErrorState
      ...
      <Section title="Full-page fallback">
        ...
        <button type="button" className="pg-btn pg-btn--danger" onClick={() => setBoom(true)}>
